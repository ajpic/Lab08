...
#Here, things get a little more interesting. I'm using a conditional if-
#statement where I'm checking
...
if(userName.lower() == "andrew" and userPassword == "AndrewsPassword"):
...
#output would be
#`hello` in all lowercase character
